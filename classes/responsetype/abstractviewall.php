...
/**
 * Shared renderer for displaying all responses.
 *
 ...
 */
abstract class abstractviewall extends abstractoutput implements renderable, templatable {
    /**
     * Provides the response collection for the template.
     *
     * @return array
     */
    abstract protected function get_responses(): array;
    ...
    public function export_for_template(renderer_base $output): object {
        ...
        $data->all_responses = $this->get_responses();
        ...
        $this->prepare_dates($data->all_responses);
